...
const showData = (allData) => {
    ...
    newDiv.innerHTML = `
                    <div class="flex gap-10 rounded-[24px]  w-[66%] border-2 border-green-500 h-[270px] bg-[#797DFC1A] pl-10 pr-10 pt-10">
                        <!-- left side image  -->
                         ...
                         <!-- right side contents -->
                          <div class="flex flex-col w-full  border-2 border-red-500">
                              ...
                              <h1 class="text-[#12132D] font-mulish text-xl font-bold mt-3">${data.title}</h1>
